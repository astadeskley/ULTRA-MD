...
const defaultOwner = '50938183845';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '50938183845';  // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '50938183845';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['50938183845', '50943537289']
...
// Sticker WM
global.premium = 'true'
global.packname = 'Zeee'
global.author = '𓃶βΔT->𝐋𝚵𝐘🕷️ ᶜʳᵉᵛⁱᵗᵒ™𝙍𝙨𝙢🕷️𓃶'
